...
class StorageRepositoryImpl(context: Context): StrotageRepository {
    ...
    private val sharedPreferences = _context.getSharedPreferences(SHARED_PREFERENCES_NAME, Context.MODE_PRIVATE)
    override fun getMainParamFromStorage(): String {
    ...
    override fun setDataInStorage(mainParam: String?,
        ...
        sharedPreferences.edit().apply{
            ...
            if(mainParam != null)
                putString(MAIN_PARAM_KEY, mainParam)
